    ...
    <footer className="bg-primary text-slate-300 pt-16 pb-8 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-6">
            <Link href="/" className="flex items-center gap-2 text-white">
              ...
              <span className="font-bold text-xl tracking-tight">ESOA Tech</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3 text-sm">
                ...
                <span>contact@esoatech.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-slate-800 text-sm text-center text-slate-500">
          <p>&copy; {new Date().getFullYear()} ESOA Technologies. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
